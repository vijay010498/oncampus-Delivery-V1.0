...
import com.svijayr007.oncampusdelivery.ui.login.LoginActivity;
import com.svijayr007.oncampusdelivery.ui.no_internet.NoInternetActivity;
import com.svijayr007.oncampusdelivery.ui.signup.SignupActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void init() {
        deliveryAgentRef = FirebaseDatabase.getInstance(Common.deliveryAgentsDB)
    ...
    private void checkPartnerFromFirebase(FirebaseUser user) {
        deliveryAgentRef.child(user.getUid())
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()){
                            DeliveryAgentUserModel deliveryAgentUserModel = snapshot.getValue(DeliveryAgentUserModel.class);
                            Common.currentDeliveryAgentUser = deliveryAgentUserModel;
                            if(deliveryAgentUserModel.isActive()){
                                goToHomeActivity(deliveryAgentUserModel);
    ...
    private void goToHomeActivity(DeliveryAgentUserModel deliveryAgentUserModel) {
